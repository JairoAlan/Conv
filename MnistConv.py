...
''' implementa el entrenamiento de una red neuronal convolucional 
utilizando el conjunto de datos MNIST, utilizando la técnica de 
descenso de gradiente con momentum para optimizar los pesos de la red.'''
