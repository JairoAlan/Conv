...
''' implementa una capa de agrupación que reduce la dimensionalidad de las imágenes de salida 
de una capa convolucional, lo que ayuda a reducir el costo computacional y el overfitting en 
